...
func Test_isOn(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "on/off on allowlist", args: args{options: []FeatureToggleOptions{WithAttributes(attrs)}, ft: &pb_ft.FeatureToggle{Name: "FOO", ToggleType: pb_ft.FeatureToggle_ON_OFF, Enabled: true, FeatureDefinition: &pb_ft.FeatureToggle_OnOff{OnOff: &pb_ft.OnOffFeature{Off: &pb_ft.Variant{Weight: 100}, On: &pb_ft.Variant{Weight: 0, Matches: []*pb_ft.Match{{Key: &pb_ft.Key{Key: "project_id", KeyType: pb_ft.Key_FLOAT}, Operation: &pb_ft.Match_FloatOp{FloatOp: &pb_ft.FloatOp{Op: pb_ft.FloatOp_EQ, Values: []float32{123}}}}}}}}}}, want: true, wantErr: false},
		{name: "on/off off allowlist", args: args{options: []FeatureToggleOptions{WithAttributes(attrs)}, ft: &pb_ft.FeatureToggle{Name: "FOO", ToggleType: pb_ft.FeatureToggle_ON_OFF, Enabled: true, FeatureDefinition: &pb_ft.FeatureToggle_OnOff{OnOff: &pb_ft.OnOffFeature{Off: &pb_ft.Variant{Weight: 100}, On: &pb_ft.Variant{Weight: 0, Matches: []*pb_ft.Match{{Key: &pb_ft.Key{Key: "project_id", KeyType: pb_ft.Key_FLOAT}, Operation: &pb_ft.Match_FloatOp{FloatOp: &pb_ft.FloatOp{Op: pb_ft.FloatOp_EQ, Values: []float32{1234}}}}}}}}}}, want: false, wantErr: false},
		{name: "on/off off disallowlist", args: args{options: []FeatureToggleOptions{WithAttributes(attrs)}, ft: &pb_ft.FeatureToggle{Name: "FOO", ToggleType: pb_ft.FeatureToggle_ON_OFF, Enabled: true, FeatureDefinition: &pb_ft.FeatureToggle_OnOff{OnOff: &pb_ft.OnOffFeature{On: &pb_ft.Variant{Weight: 100}, Off: &pb_ft.Variant{Matches: []*pb_ft.Match{{Key: &pb_ft.Key{Key: "project_id", KeyType: pb_ft.Key_FLOAT}, Operation: &pb_ft.Match_FloatOp{FloatOp: &pb_ft.FloatOp{Op: pb_ft.FloatOp_EQ, Values: []float32{123}}}}}}}}}}, want: false, wantErr: false},
		...
		{name: "percentage random off", args: args{options: []FeatureToggleOptions{WithAttributes(attrs)}, ft: &pb_ft.FeatureToggle{Name: "FOO", ToggleType: pb_ft.FeatureToggle_PERCENTAGE, Enabled: true, FeatureDefinition: &pb_ft.FeatureToggle_Percentage{Percentage: &pb_ft.PercentageFeature{On: &pb_ft.Variant{Weight: 0}, Off: &pb_ft.Variant{Weight: 100}, Stickiness: &pb_ft.Stickiness{StickinessType: pb_ft.Stickiness_KEYS, Keys: []*pb_ft.Key{{Key: "project_id", KeyType: pb_ft.Key_FLOAT}}}}}}}, want: false, wantErr: false},
		{name: "percentage sticky 70%", args: args{options: []FeatureToggleOptions{WithAttributes(attrs)}, ft: &pb_ft.FeatureToggle{Name: "FOO", ToggleType: pb_ft.FeatureToggle_PERCENTAGE, Enabled: true, FeatureDefinition: &pb_ft.FeatureToggle_Percentage{Percentage: &pb_ft.PercentageFeature{On: &pb_ft.Variant{Weight: 70}, Off: &pb_ft.Variant{Weight: 30}, Stickiness: &pb_ft.Stickiness{StickinessType: pb_ft.Stickiness_KEYS, Keys: []*pb_ft.Key{{Key: "project_id", KeyType: pb_ft.Key_FLOAT}}}}}}}, want: true, wantErr: false},
		{name: "percentage sticky 60%", args: args{options: []FeatureToggleOptions{WithAttributes(attrs)}, ft: &pb_ft.FeatureToggle{Name: "FOO", ToggleType: pb_ft.FeatureToggle_PERCENTAGE, Enabled: true, FeatureDefinition: &pb_ft.FeatureToggle_Percentage{Percentage: &pb_ft.PercentageFeature{On: &pb_ft.Variant{Weight: 60}, Off: &pb_ft.Variant{Weight: 40}, Stickiness: &pb_ft.Stickiness{StickinessType: pb_ft.Stickiness_KEYS, Keys: []*pb_ft.Key{{Key: "project_id", KeyType: pb_ft.Key_FLOAT}}}}}}}, want: false, wantErr: false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
